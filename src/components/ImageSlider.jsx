  ...
  return (
    <div className="hero" onClick={isOpen || notification ? turnoff : null}>
      <div className="container">
        <div className="card ">
          <div className="left-angel-arrow-pointer" onClick={goToPrevious}>
            &#10096;
          </div>
          <div className="right-angel-arrow-pointer" onClick={goToNext}>
            &#10097;
          </div>
          <img
            ...
            width="100%"
            effect="blur"
            placeholderSrc={slides[currentIndex].src}
          />
        ...
        <div className="dots-list">
          {slides.map((slide, slideIndex) => (
            <div
              key={slideIndex}
              className={currentIndex === slideIndex ? "dots active" : "dots"}
